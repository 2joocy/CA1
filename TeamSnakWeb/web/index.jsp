...
<html>
    ...
    <div style="padding: 10px;  margin: auto; width: 80%; border: 3px solid #5D6D7E; border-radius: 5px; padding: 10px; background-color: #2E4053; color: white;">
        ...
        <p><h3>Downloads</h3></p>
        <p>In case you're interested in seeing the program in action, you can download the client <a href='https://dl.dropboxusercontent.com/s/u74dlbzamlpxkye/Hold_Snak-2018.jar?dl=0#'>here</a></p>
        <h2>Documentation</h2>
        <p><h3>Class Tests</h3>
            <p>
